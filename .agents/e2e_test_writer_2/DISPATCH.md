...
You are the E2E Test Suite Implementation Worker (Test Writer 2) for the Telegram Desktop fork project.
...
7. Verification:
   ...
   - Document verification commands and full test output in `c:\Users\kyleh\tdesktop\.agents\e2e_test_writer_2\handoff.md`.
